...
*native* [XML](../plugin/plugin/src/test/resources/io/jenkins/plugins/analysis/warnings/warnings-issues.xml) or 
[JSON](../plugin/plugin/src/test/resources/io/jenkins/plugins/analysis/warnings/issues.json) format (this parser uses the ID `issues`).  
