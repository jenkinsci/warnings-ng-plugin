<!--- DO NOT EDIT - Generated by ToolsLister at 2019-11-13T07:59:00.055-->
...
| 77 | protolint | protoLint() | - - | [ProtoLint](https://github.com/yoheimuta/protolint) |  |
| 78 | puppetlint | puppetLint() | - - | Puppet-Lint |  |
| 79 | pvs-studio | PVSStudio() | ![PVS-Studio](src/main/webapp/icons/pvs-24x24.png) ![PVS-Studio](src/main/webapp/icons/pvs-48x48.png) | [PVS-Studio](https://www.viva64.com/en/pvs-studio/) | **/*.plog |
| 80 | pydocstyle | pyDocStyle() | - - | Pydocstyle |  |
| 81 | pylint | pyLint() | ![Pylint](src/main/webapp/icons/pylint-24x24.png) ![Pylint](src/main/webapp/icons/pylint-48x48.png) | Pylint |  |
| 82 | qac | qacSourceCodeAnalyser() | - - | QA-C Sourcecode Analyser |  |
| 83 | dupfinder | dupFinder() | ![Resharper dupFinder](src/main/webapp/icons/dry-24x24.png) ![Resharper dupFinder](src/main/webapp/icons/dry-48x48.png) | Resharper dupFinder |  |
| 84 | resharper | resharperInspectCode() | ![Resharper InspectCode](src/main/webapp/icons/resharper-24x24.png) ![Resharper InspectCode](src/main/webapp/icons/resharper-48x48.png) | Resharper InspectCode |  |
| 85 | robocopy | robocopy() | - - | Robocopy |  |
| 86 | rflint | rfLint() | ![Robot Framework Lint](src/main/webapp/icons/robot-framework-24x24.png) ![Robot Framework Lint](src/main/webapp/icons/robot-framework-48x48.png) | Robot Framework Lint |  |
| 87 | rubocop | ruboCop() | ![RuboCop](src/main/webapp/icons/rubocop-24x24.png) ![RuboCop](src/main/webapp/icons/rubocop-48x48.png) | RuboCop |  |
| 88 | scala | scala() | ![Scala Compiler](src/main/webapp/icons/scala-24x24.png) ![Scala Compiler](src/main/webapp/icons/scala-48x48.png) | Scala Compiler |  |
| 89 | simian | simian() | ![Simian](src/main/webapp/icons/dry-24x24.png) ![Simian](src/main/webapp/icons/dry-48x48.png) | Simian |  |
| 90 | sonar | sonarQube() | ![SonarQube](src/main/webapp/icons/sonar-24x24.png) ![SonarQube](src/main/webapp/icons/sonar-48x48.png) | SonarQube | **/sonar-report.json |
| 91 | sphinx | sphinxBuild() | - - | Sphinx-build |  |
| 92 | spotbugs | spotBugs() | ![SpotBugs](src/main/webapp/icons/spotbugs-24x24.png) ![SpotBugs](src/main/webapp/icons/spotbugs-48x48.png) | [SpotBugs](https://spotbugs.github.io) | **/spotbugsXml.xml |
| 93 | stylecop | styleCop() | - - | StyleCop |  |
| 94 | sunc | sunC() | - - | SUN C&#43;&#43; Compiler |  |
| 95 | swiftlint | swiftLint() | - - | [SwiftLint](https://github.com/realm/SwiftLint) |  |
| 96 | tasking-vx | taskingVx() | - - | TASKING VX Compiler |  |
| 97 | code-composer | tiCss() | - - | Texas Instruments Code Composer Studio |  |
| 98 | tnsdl | tnsdl() | - - | TNSDL Translator |  |
| 99 | tslint | tsLint() | - - | [TSLint](https://palantir.github.io/tslint/) |  |
| 100 | issues | issues() | - - | [Warnings Plugin Native Format](https://github.com/jenkinsci/warnings-ng-plugin/blob/master/doc/Documentation.md#export-your-issues-into-a-supported-format) |  |
| 101 | diabc | diabC() | - - | Wind River Diab Compiler (C/C&#43;&#43;) |  |
| 102 | xmllint | xmlLint() | - - | XML Lint |  |
| 103 | yamllint | yamlLint() | - - | [YamlLint](https://yamllint.readthedocs.io/) |  |
| 104 | yui | yuiCompressor() | - - | YUI Compressor |  |
| 105 | zptlint | zptLint() | - - | ZPT Lint |  |
