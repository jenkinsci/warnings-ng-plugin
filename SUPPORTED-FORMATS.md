<!--- DO NOT EDIT - Generated by ToolsLister at 2019-09-11T22:02:06.293-->
...
| 78 | pvs-studio | PVSStudio() | ![PVS-Studio](src/main/webapp/icons/pvs-24x24.png) ![PVS-Studio](src/main/webapp/icons/pvs-48x48.png) | [PVS-Studio](https://www.viva64.com/en/pvs-studio/) | **/*.plog |
| 79 | pydocstyle | pyDocStyle() | - - | Pydocstyle |  |
| 80 | pylint | pyLint() | ![Pylint](src/main/webapp/icons/pylint-24x24.png) ![Pylint](src/main/webapp/icons/pylint-48x48.png) | Pylint |  |
| 81 | qac | qacSourceCodeAnalyser() | - - | QA-C Sourcecode Analyser |  |
| 82 | dupfinder | dupFinder() | ![Resharper dupFinder](src/main/webapp/icons/dry-24x24.png) ![Resharper dupFinder](src/main/webapp/icons/dry-48x48.png) | Resharper dupFinder |  |
| 83 | resharper | resharperInspectCode() | ![Resharper InspectCode](src/main/webapp/icons/resharper-24x24.png) ![Resharper InspectCode](src/main/webapp/icons/resharper-48x48.png) | Resharper InspectCode |  |
| 84 | robocopy | robocopy() | - - | Robocopy |  |
| 85 | rflint | rfLint() | ![Robot Framework Lint](src/main/webapp/icons/robot-framework-24x24.png) ![Robot Framework Lint](src/main/webapp/icons/robot-framework-48x48.png) | Robot Framework Lint |  |
| 86 | rubocop | ruboCop() | ![RuboCop](src/main/webapp/icons/rubocop-24x24.png) ![RuboCop](src/main/webapp/icons/rubocop-48x48.png) | RuboCop |  |
| 87 | scala | scala() | ![Scala Compiler](src/main/webapp/icons/scala-24x24.png) ![Scala Compiler](src/main/webapp/icons/scala-48x48.png) | Scala Compiler |  |
| 88 | simian | simian() | ![Simian](src/main/webapp/icons/dry-24x24.png) ![Simian](src/main/webapp/icons/dry-48x48.png) | Simian |  |
| 89 | sonar | sonarQube() | ![SonarQube](src/main/webapp/icons/sonar-24x24.png) ![SonarQube](src/main/webapp/icons/sonar-48x48.png) | SonarQube | **/sonar-report.json |
| 90 | sphinx | sphinxBuild() | - - | Sphinx-build |  |
| 91 | spotbugs | spotBugs() | ![SpotBugs](src/main/webapp/icons/spotbugs-24x24.png) ![SpotBugs](src/main/webapp/icons/spotbugs-48x48.png) | [SpotBugs](https://spotbugs.github.io) | **/spotbugsXml.xml |
| 92 | stylecop | styleCop() | - - | StyleCop |  |
| 93 | sunc | sunC() | - - | SUN C&#43;&#43; Compiler |  |
| 94 | swiftlint | swiftLint() | - - | [SwiftLint](https://github.com/realm/SwiftLint) |  |
...
| 98 | tslint | tsLint() | - - | [TSLint](https://palantir.github.io/tslint/) |  |
| 99 | issues | issues() | - - | [Warnings Plugin Native Format](https://github.com/jenkinsci/warnings-ng-plugin/blob/master/doc/Documentation.md#export-your-issues-into-a-supported-format) |  |
| 100 | diabc | diabC() | - - | Wind River Diab Compiler (C/C&#43;&#43;) |  |
| 101 | xmllint | xmlLint() | - - | XML Lint |  |
| 102 | yamllint | yamlLint() | - - | [YamlLint](https://yamllint.readthedocs.io/) |  |
