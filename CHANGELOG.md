...
- [JENKINS-58056](https://issues.jenkins.io/browse/JENKINS-58056),
...
- [JENKINS-55051](https://issues.jenkins.io/browse/JENKINS-55051),
...
### Fixed
- [JENKINS-58253](https://issues.jenkins.io/browse/JENKINS-58253): Restored deprecated quality gate 
...
### Added 
- [JENKINS-39203](https://issues.jenkins.io/browse/JENKINS-39203),
...
- [JENKINS-57245](https://issues.jenkins.io/browse/JENKINS-57245), [PR#111](https://github.com/jenkinsci/warnings-ng-plugin/pull/111):
  Added a Kotlin Parser.

### Fixed
- [JENKINS-56007](https://issues.jenkins.io/browse/JENKINS-56007): Obtain the affected files in a process on the 
...
- [JENKINS-56484](https://issues.jenkins.io/browse/JENKINS-56484),
...
- [JENKINS-56324](https://issues.jenkins.io/browse/JENKINS-56324): 
...
- [JENKINS-56418](https://issues.jenkins.io/browse/JENKINS-56418), 
...
[JENKINS-49965](https://issues.jenkins.io/browse/JENKINS-49965): Improved performance of issues table.
- [JENKINS-44915](https://issues.jenkins.io/browse/JENKINS-44915): Show description of Pylint rules in details.
...
- [JENKINS-56182](https://issues.jenkins.io/browse/JENKINS-56182): 
...
### Fixed
- [JENKINS-56142](https://issues.jenkins.io/browse/JENKINS-56142): 
Fixed broken quality gate UI configuration (snippet generator).
- [JENKINS-50355](https://issues.jenkins.io/browse/JENKINS-50355): 
Fixed validation of DRY thresholds.
- [JENKINS-56103](https://issues.jenkins.io/browse/JENKINS-56103): 
Changed ID/URL of Maven Console Parser to 'maven-warnings' since 'maven' is already used by another plugin. 
- [JENKINS-55436](https://issues.jenkins.io/browse/JENKINS-55436): 
...
### Added
- [JENKINS-54550](https://issues.jenkins.io/browse/JENKINS-54550), 
[JENKINS-52098](https://issues.jenkins.io/browse/JENKINS-52098):
...
### Added
- [JENKINS-22526](https://issues.jenkins.io/browse/JENKINS-22526), 
[JENKINS-17196](https://issues.jenkins.io/browse/JENKINS-17196):
...
[JENKINS-51439](https://issues.jenkins.io/browse/JENKINS-51439): 
Group issues by folder if no package is available.
- [JENKINS-55442](https://issues.jenkins.io/browse/JENKINS-55442): Added include/exclude filters for issue messages. 
...
### Added
- [JENKINS-55500](https://issues.jenkins.io/browse/JENKINS-55500): dashboard view portlet
  - make tool selection configurable
  - provide direct links to the analysis results
- [JENKINS-52755](https://issues.jenkins.io/browse/JENKINS-52755), [JENKINS-54239](https://issues.jenkins.io/browse/JENKINS-54239):
View column that shows the number of issues.
- Click on trend chart to navigate to selected analysis results. 

### Fixed
- [JENKINS-55674](https://issues.jenkins.io/browse/JENKINS-55674), [JENKINS-55564](https://issues.jenkins.io/browse/JENKINS-55564): 
redraw tables after restoring the paging size.
- [JENKINS-55679](https://issues.jenkins.io/browse/JENKINS-55679): fixed rendering of XML files in source view.
...
- [JENKINS-55500](https://issues.jenkins.io/browse/JENKINS-55500): Added a portlet that renders a two-dimensional 
...
- [JENKINS-55298](https://issues.jenkins.io/browse/JENKINS-55298): Improved documentation of Groovy script syntax 
- [JENKINS-55293](https://issues.jenkins.io/browse/JENKINS-55293): Improved health report validation error messages 
