...
public class FilesParser extends MasterToSlaveFileCallable<ParserResult> {
    ...
    /**
     * Creates a new instance of {@link hudson.plugins.analysis.core.FilesParser}. Since no file pattern is
    ...
    /**
     * Creates a new instance of {@link hudson.plugins.analysis.core.FilesParser}.
     *
     * @param pluginId
     *            the ID of the plug-in that uses this parser
     * @param filePattern
    ...
    /**
     * Creates a new instance of {@link hudson.plugins.analysis.core.FilesParser}. Assumes that this is a
