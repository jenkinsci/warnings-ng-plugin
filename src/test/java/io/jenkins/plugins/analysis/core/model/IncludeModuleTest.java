...
import io.jenkins.plugins.analysis.core.model.IncludeModule.DescriptorImpl;
import static org.assertj.core.api.Assertions.*;

/**
 * Unit test for {@link IncludeModule}.
 *
 * @author Frank Christian Geyer
 * @author Deniz Mardin
 */
class IncludeModuleTest extends IssuesFilterTestUtil {

    private static final String FILTER_NAME_TO_CHECK = "ModuleName1";
    private static final String DESCRIPTOR_NAME = "Include modules";
    ...
    void shouldReturnExpectedDescriptor() {
        IncludeModuleDescriptorImplAssert.assertThat(new DescriptorImpl()).hasDisplayName(DESCRIPTOR_NAME);
    }

    private IssuesFilter getIssuesFilterInstance() {
        return new IncludeModule();
    }
