...
import io.jenkins.plugins.analysis.core.model.ExcludeFile.DescriptorImpl;
import static org.assertj.core.api.Assertions.*;

/**
 * Unit test for {@link ExcludeFile}.
 *
 * @author Frank Christian Geyer
 * @author Deniz Mardin
 */
class ExcludeFileTest extends IssuesFilterTestUtil {

    private static final String FILTER_NAME_TO_CHECK = "FileName1";
    private static final String DESCRIPTOR_NAME = "Exclude file names";
    ...
    void shouldReturnExpectedDescriptor() {
        ExcludeFileDescriptorImplAssert.assertThat(new DescriptorImpl()).hasDisplayName(DESCRIPTOR_NAME);
    }
