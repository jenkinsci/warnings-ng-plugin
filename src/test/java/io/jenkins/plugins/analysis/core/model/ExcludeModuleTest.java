...
import io.jenkins.plugins.analysis.core.model.ExcludeModule.DescriptorImpl;
import static org.assertj.core.api.Assertions.*;

/**
 * Unit test for {@link ExcludeModule}.
 *
 * @author Frank Christian Geyer
 * @author Deniz Mardin
 */
class ExcludeModuleTest extends IssuesFilterTestUtil {

    private static final String FILTER_NAME_TO_CHECK = "ModuleName1";
    private static final String DESCRIPTOR_NAME = "Exclude modules";
    ...
    void shouldReturnExpectedDescriptor() {
        ExcludeModuleDescriptorImplAssert.assertThat(new DescriptorImpl()).hasDisplayName(DESCRIPTOR_NAME);
    }

    private IssuesFilter getIssuesFilterInstance() {
        return new ExcludeModule();
    }
}
