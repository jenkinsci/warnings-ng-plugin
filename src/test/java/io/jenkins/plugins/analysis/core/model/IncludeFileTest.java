...
import io.jenkins.plugins.analysis.core.model.IncludeFile.DescriptorImpl;
import static org.assertj.core.api.Assertions.*;

/**
 * Unit test for {@link IncludeFile}.
 *
 * @author Frank Christian Geyer
 * @author Deniz Mardin
 */
class IncludeFileTest extends IssuesFilterTestUtil {

    private static final String FILTER_NAME_TO_CHECK = "FileName1";
    private static final String DESCRIPTOR_NAME = "Include file names";
    ...
    void shouldReturnExpectedDescriptor() {
        IncludeFileDescriptorImplAssert.assertThat(new DescriptorImpl()).hasDisplayName(DESCRIPTOR_NAME);
    }
