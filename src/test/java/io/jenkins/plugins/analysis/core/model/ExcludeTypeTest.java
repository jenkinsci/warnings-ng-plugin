...
import io.jenkins.plugins.analysis.core.model.ExcludeType.DescriptorImpl;
import static org.assertj.core.api.Assertions.*;

/**
 * Unit test for {@link ExcludeType}.
 *
 * @author Frank Christian Geyer
 * @author Deniz Mardin
 */
class ExcludeTypeTest extends IssuesFilterTestUtil {

    private static final String FILTER_NAME_TO_CHECK = "Type1";
    private static final String DESCRIPTOR_NAME = "Exclude types";
    ...
    void shouldReturnExpectedDescriptor() {
        ExcludeTypeDescriptorImplAssert.assertThat(new DescriptorImpl()).hasDisplayName(DESCRIPTOR_NAME);
    }
