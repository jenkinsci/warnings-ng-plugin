...
import io.jenkins.plugins.analysis.core.model.IncludePackage.DescriptorImpl;
import static org.assertj.core.api.Assertions.*;

/**
 * Unit test for {@link IncludePackage}.
 *
 * @author Frank Christian Geyer
 * @author Deniz Mardin
 */
class IncludePackageTest extends IssuesFilterTestUtil {

    private static final String FILTER_NAME_TO_CHECK = "PackageName1";
    private static final String DESCRIPTOR_NAME = "Include packages";
    ...
    void shouldReturnExpectedDescriptor() {
        IncludePackageDescriptorImplAssert.assertThat(new DescriptorImpl()).hasDisplayName(DESCRIPTOR_NAME);
    }

    private IssuesFilter getIssuesFilterInstance() {
        return new IncludePackage();
    }
