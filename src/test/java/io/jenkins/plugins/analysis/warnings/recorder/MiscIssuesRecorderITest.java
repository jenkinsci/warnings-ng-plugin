...
public class MiscIssuesRecorderITest extends IntegrationTestWithJenkinsPerSuite {
    ...
    public void shouldCreateFixedWarnings() {
        ...
        HtmlPage buildPage = getWebPage(JsSupport.NO_JS, baselineResult.getOwner());
        ...
        SummaryBox resultSummary = new SummaryBox(getWebPage(JsSupport.NO_JS, result.getOwner()), "eclipse");
    ...
    private void verifyBaselineDetails(final AnalysisResult baseline) {
        HtmlPage baselineDetails = getWebPage(JsSupport.JS_ENABLED, baseline);
