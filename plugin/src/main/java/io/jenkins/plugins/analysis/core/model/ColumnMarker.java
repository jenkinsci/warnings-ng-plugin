...
/**
 * Encloses columns between start and end with a HTML tag {@code openingTag} {@code closingTag}.
 */
...
public final class ColumnMarker {
     ...
     *         later be replaced with the HTML tag {@code openingTag} {@code closingTag}.
